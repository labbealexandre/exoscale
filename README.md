...
This package implements the [libdns interfaces](https://github.com/libdns/libdns) for [exoscale.com](https://www.exoscale.com), allowing you to manage DNS records.
